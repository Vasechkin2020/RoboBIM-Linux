...
pb_msgs::topicPillar pillar_msg; // Структура в которую пишем обработанны данные о местонахождении столбов
...
int main(int argc, char **argv)
{
    ...
    ros::Publisher pub_topicPillar = nh.advertise<pb_msgs::topicPillar>("pbStart/Pillar", 16);             // Это мы обьявляем для публикации всех столбов в своем сообщении
