...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
        ...
        if (rezData) // Если пришли хорошие данные то обрабатываем их и публикуем данные в ROS
        {
            ...
            topic.processing_SetSpeed(Data2Driver.control); // Заполнение и публикация заданной скорости Публикуем если только ее успешно отправили на нижний уровень
        }
        //-----------------------------------------------------------------------------------------------------------------------------------
