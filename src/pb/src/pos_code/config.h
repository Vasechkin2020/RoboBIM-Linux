...
#define RATE_LASER 3                            // Частота измерения лазерного датчика
...
SOdom odomMode11; // Высчитанная одометрия скомплементированная из Odom0 и Odom1
SOdom odomMode12; // Высчитанная одометрия скомплементированная из Odom0 и Odom1
SOdom odomMode13; // Высчитанная одометрия скомплементированная из Odom0 и Odom1
