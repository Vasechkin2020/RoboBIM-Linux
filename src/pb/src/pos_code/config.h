...
SLinearAngularVelocity g_linAngVel;// Линейная и угловая скорость полученная с колес и с датчика MPU IMU
...
// SOdom odomMode10; // Высчитанная одометрия скомплементированная из Odom0 и Odom1
SOdom odomMode11; // Высчитанная одометрия скомплементированная из MODE1 и скоростей из MODE0 и угла из MODE5
SOdom odomMode12; // Высчитанная одометрия скомплементированная из MODE2 и скоростей из MODE0 и угла из MODE5
SOdom odomMode13; // Высчитанная одометрия скомплементированная из MODE3 и скоростей из MODE0 и угла из MODE5
