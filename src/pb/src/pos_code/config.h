...
//--------------------------------- ПОДПИСКА НА ТОПИКИ -------------------------------------------------
pb_msgs::Struct_PoseLidar msg_lidar;   // Перемеенная в которую сохраняем данные лидара из сообщения
...
struct SPoseBase // Варианты расчетов координат лидара
{
    SPose mode;      // Для лидара по растоянию
    SPose lidar;     // Для лидара по растоянию
    SPose laser;     // Для лидара по растоянию
    SPose fused;     // //
    SPose odom;      // //
    SPose imu;      // //
