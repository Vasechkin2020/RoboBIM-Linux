...
#define RATE 50 // Частота обмена с нижним уровнев в Герц
//---------------------------------------------------------------------------------------
...
SOdom odomWheelCorrect; // Высчитанная одометрия по энкодеру скорректированная
...
STwistDt encTwistDt; // Скорости полученные по ecoder и интревал который прошел с предыдущего измерения
...
SPoseTrue g_poseControl; // Позиция с верхнего уровня на которую надо подменить текущую позицию
// ============================================================
